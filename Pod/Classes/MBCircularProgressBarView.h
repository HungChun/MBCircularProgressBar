...
/**
 * Should show subtitle screen
 */
@property (nonatomic,assign) IBInspectable BOOL      showSubtitleString;

/**
 * The name of the font of the subtitle string
 */
@property (nonatomic,copy)   IBInspectable NSString  *subtitleFontName;

/**
 * The font size of the subtitle text	[0,∞)
 */
@property (nonatomic,assign) IBInspectable CGFloat   subtitleFontSize;

/**
 * The string that represents the subtitle, usually %
 */
@property (nonatomic,copy)   IBInspectable NSString  *subtitleString;
